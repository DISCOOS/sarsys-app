...
void main() async {
  ...
  group('WHEN OperationBloc is ONLINE', () {
    test('SHOULD load operations', () async {
      ...
      final localOperations = await (harness.operationsBloc!.load() as FutureOr<List<Operation>>);
    ...
    test('SHOULD update operation and push to backend', () async {
      ...
      // Act
      final changed = await (harness.operationsBloc!.update(operation.copyWith(name: "Changed")) as FutureOr<Operation>);
  ...
  group('WHEN OperationBloc is OFFLINE', () {
    test('SHOULD load as EMPTY', () async {
      ...
      // Act
      List<Operation> operations = await (harness.operationsBloc!.load() as FutureOr<List<Operation>>);

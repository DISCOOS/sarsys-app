...
void main() async {
  ...
  group('WHEN personnelBloc is ONLINE', () {
    test('SHOULD load personnel', () async {
      ...
      // Act
      List<Personnel> cached = await (harness.personnelBloc!.load() as FutureOr<List<Personnel>>);
  ...
  group('WHEN personnelBloc is OFFLINE', () {
    test('SHOULD load as EMPTY', () async {
      ...
      // Act
      List<Personnel> personnel = await (harness.personnelBloc!.load() as FutureOr<List<Personnel>>);
